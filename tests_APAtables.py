...
#The tests below go throguh each test from the csv, set the global variables, use the deicision funcs (which trigger the main funcs) to generate APA tables
...
#For example, if on my computer I change the VALUE of an expected Excel table, an error will pop up on the border of the first cell (A1) and its color will not match.
